...
class CreditCard(SETIOrders):
    ...
    def __repr__(self):
        retv = '<CreditCard>\n'
        retv = self.formatSimpleProperty(retv,'Number',self.card_number)
        retv = self.formatSimpleProperty(retv,'FullName',self.card_holder)
        retv = self.formatSimpleProperty(retv,'ExpirationDate',self.expiration_date)
        retv = self.formatSimpleProperty(retv,'VerificationValue',self.cvv)
        retv = self.formatSimpleProperty(retv,'Company',self.company_holder)
        retv = self.formatSimpleProperty(retv,'BankName',self.issuing_bank)
        retv = self.formatSimpleProperty(retv,'AVS',self.avs)
        retv = self.formatSimpleProperty(retv,'TransID',self.transaction_id)
        retv = self.formatSimpleProperty(retv,'AuthCode',self.auth_code)
        retv = self.formatSimpleProperty(retv,'ProcessLevel',self.process_level)
        retv = self.formatSimpleProperty(retv,'Amount',self.amount)
        retv = self.formatSimpleProperty(retv,'IssueNumber',self.issue_number)
        retv = self.formatSimpleProperty(retv,'SecurityKey',self.security_key)
        retv = self.formatSimpleProperty(retv,'CAVV',self.cavv)
        retv = self.formatSimpleProperty(retv,'ECI',self.eci)
        retv = self.formatSimpleProperty(retv,'XID',self.xid)
        return concat(retv,'\n</CreditCard>\n')
